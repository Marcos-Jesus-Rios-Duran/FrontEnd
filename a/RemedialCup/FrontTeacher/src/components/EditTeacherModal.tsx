                ...
                <form onSubmit={handleSubmit}>
                  <div className="row mb-3">
                    <div className="col-lg-6">
                      <label htmlFor="teacher_number" className="form-label"><b>Número de Profesor</b></label>
                      <input
                        type="text"
                  ...
                  <div className="row mb-3">
                    ...
                    <div className="col-lg-6">
                      <label htmlFor="age" className="form-label"><b>Edad</b></label>
                      <input
                        type="number"
                        className="form-control"
                        id="age"
                  ...
                  <div className="row mb-3">
                    ...
                    <div className="col-lg-6">
                      <label htmlFor="salary" className="form-label"><b>Salario</b></label>
                      <input
                        type="number"
                        className="form-control"
                        id="salary"
